...
import { PAMPER_FITNESS } from "../../actions/types";
import {
  View,
  Text,
  StyleSheet,
...
class PamperFitnessScreen extends Component {
  static navigationOptions = ({ navigation }) => ({
    title: "PAMPER & FITNESS",
    ...
    return loading ? (
      ...
      <View style={{ backgroundColor: "white" }}>
        <Animatable.View animation="fadeIn">
          <FlatList
            data={this.props.pamperFitness.rewards}
...
const mapStateToProps = state => {
  const { pamperFitness, loading, error } = state.rewards;
  return { pamperFitness, loading, error };
};

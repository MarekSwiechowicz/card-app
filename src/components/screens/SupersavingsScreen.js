...
import { SUPERSAVINGS } from "../../actions/types";
import {
  View,
  Text,
  StyleSheet,
...
import { fetchRewards, fetchRedeem } from "../../actions";
    ...
    return loading ? (
      ...
      <View style={{ backgroundColor: "white" }}>
        <Animatable.View animation="fadeIn">
          <FlatList
            data={this.props.supersavings.rewards}
...
const mapStateToProps = state => {
  const { supersavings, loading, error } = state.rewards;
  return { supersavings, loading, error };
};

export default connect(
  mapStateToProps,
  { fetchRewards, fetchRedeem }
)(SupersavingsScreen);
